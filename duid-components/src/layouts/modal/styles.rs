...
pub(crate) fn default_modal_selectors() -> HashSet<String> {
    ...
    selectors.insert(".details-modal-reset[open] > summary::before:::fixed inset-0 z-10 block cursor-default pointer-events-none content-[\"&\"] bg-color--222-1-91 opacity-50".to_owned());
